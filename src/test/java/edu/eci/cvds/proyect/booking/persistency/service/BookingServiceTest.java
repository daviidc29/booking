...
class BookingServiceTest {
    ...
    void testGetAllBookingsSuccess() {
        ...
        Booking booking2 = new Booking(2, 10000097, LaboratoryName.FUNDAMENTOS, Day.LUNES, Hour.ONCE_TREINTA, Hour.UNA, BookingStatus.CANCELED,group);
    ...
    void testAutoIncrementSuccess() {
        ...
        BookingDto bookingDto = new BookingDto(10000087, LaboratoryName.FUNDAMENTOS, Day.LUNES, Hour.ONCE_TREINTA, Hour.UNA, BookingStatus.ACTIVED,group);
        Booking newBooking = new Booking(2, 10000097, LaboratoryName.FUNDAMENTOS, Day.LUNES, Hour.ONCE_TREINTA, Hour.UNA, BookingStatus.ACTIVED,group);
    ...
    void testAutoIncrementFailure() {
        ...
        Integer newId = bookingService.save(new BookingDto(10000087, LaboratoryName.FUNDAMENTOS, Day.LUNES, Hour.ONCE_TREINTA, Hour.UNA, BookingStatus.ACTIVED,group)).getId();
