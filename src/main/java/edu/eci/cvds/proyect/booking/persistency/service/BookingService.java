...
public class BookingService {
    ...
    public Booking save(BookingDto bookingDto){
        ...
        Booking booking = new Booking(id, bookingDto.getUserId(), bookingDto.getLaboratoryName(), bookingDto.getDay(),bookingDto.getStartHour(),bookingDto.getEndHour(),bookingDto.getStatus(),bookingDto.getGroupId());
    ...
    public Booking update(Integer id, BookingDto bookingDto){
        ...
        booking.setGroupId(bookingDto.getGroupId());
        return bookingRepository.save(booking);
    }
